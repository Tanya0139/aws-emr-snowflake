...
job_flow_overrides = {
    ...
    "LogUri": "s3://redfin-data-project-yml-tanya/emr-logs-yml/",
...
SPARK_STEPS_EXTRACTION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                "s3://redfin-data-project-yml-tanya/scripts/ingest.sh",
            ],
        },
    },
   ]
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit",
            "s3://redfin-data-project-yml-tanya/scripts/transform_redfin_data.py",
            ],
        },
    },
   ]
