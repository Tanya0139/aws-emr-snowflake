...
def transform_date():
    raw_data_s3_bucket = "s3://redfin-data-project-yml-tanya/store-raw-data-yml/city_market_tracker.tsv000.gz"
    transform_data_s3_bucket = "s3://redfin-data-project-yml-tanya/redfin-transform-zone-yml/redfin_data.parquet"
